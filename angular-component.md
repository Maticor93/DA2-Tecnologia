...
Un template HTML por si solo estaria mostrando un contenido estatico, lo cual no es suficiente para construir SPAs con contenidos dinamicos. Es por eso que existe lo llamado data binding que permite combinar codigo HTML con ciertas sintaxis de Angular las cuales pueden modificar los elementos HTML antes de ser visualizados. Las directivas del template proveen logica, y las sintaxis de Angular conectan la data de la aplicacion con el DOM. Hay dos tipos de data binding:
